<%@ Page Title="Vista de actividades de la SESCESP" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vista_de_datos_SESCESP.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.CVcMyCPC.Vista_de_datos_SESCESP" %>
        ...
        <div class="row">
            <div id="sidebar">
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            <h1>VISTA DE RESÚMENES DEL SESCESP</h1>
                ...
                <asp:UpdatePanel runat="server" ID="upd">
                    <ContentTemplate>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaPCaAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) and (it.Dependencia == 'SESCESP' )  AND
                            ...
                            $.getJSON(url, function (data) {
                                ...
                                for (f; f < data.Puntos.length; f++) {
                                    ...
                                    switch (data.Puntos[f].id) {
                                        case 27:
                                            imgTipoAlerta = "../../Imagenes/Banner/CVcMyCPC/Pines/Enlace.png";
                                            break;
                                        case 28:
                                            imgTipoAlerta = "../../Imagenes/Banner/CVcMyCPC/Pines/VinculacionI.png";
                                            break;
