<%@ Page Title="Vista de datos del C4" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vista_de_datos_de_actividades_C4.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.C4.Vista_de_datos_de_actividades_C4" %>
        ...
        <div class="row">
            <div id="sidebar">
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            <h1>VISTA DE RESÚMENES DEL C4</h1>
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        ...
                        <asp:EntityDataSource runat="server" ID="edsProgramasBUsca" DefaultContainerName="SIICOPEntities"
                            Where="it.programasID IN {16,17,18,19,20}"
                    ...
                    <div class="col-lg-1">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="font-size: 11px;">
                                ...
                                <%--  <li runat="server">
                                    <asp:LinkButton ID="lnBtnExpCedula" runat="server" Style="font-size: 1.5em" Text="excel" title="Exportar">Cedulas &nbsp;<span style="color:blue" class="fas fa-chart-line"></span></asp:LinkButton>
                                </li>--%>
                ...
                <asp:UpdatePanel runat="server" ID="upd">
                    <ContentTemplate>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaPCaAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) and (it.Dependencia == 'C4' )  AND
                            ...
                            $.getJSON(url, function (data) {
                                ...
                                for (f; f < data.Puntos.length; f++) {
                                    ...
                                    switch (data.Puntos[f].id) {
                                        case 16:
                                            imgTipoAlerta = "../../Imagenes/Banner/C4/Pines/Pin_Escolar.png";
                                            break;
                                        case 17:
                                            imgTipoAlerta = "../../Imagenes/Banner/C4/Pines/Pin_Empresarial.png";
                                            break;
                                        case 18:
                                            imgTipoAlerta = "../../Imagenes/Banner/C4/Pines/IP.png";
                                            break;
                                        case 19:
                                            imgTipoAlerta = "../../Imagenes/Banner/C4/Pines/Pin_RedesVecinales.png";
                                            break;
                                        case 20:
                                            imgTipoAlerta = "../../Imagenes/Banner/C4/Pines/Pin_Eventos.png";
                                            break;
