<%@ Page Title="FOMENTO A LA PREVENCIÓN A TRAVÉS DEL DEPORTE Y LA CULTURA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">FOMENTO A LA PREVENCIÓN A TRAVÉS DEL DEPORTE Y LA CULTURA</h5>
                        </div>
                        <div class="link-me">
                        </div>
                    </div>
    ...
    <div class="container-fluid">
        <div class="well" style="background-color: white">
            ...
            <asp:UpdatePanel runat="server" ID="upd">
                <ContentTemplate>
                    <div class="row">
                        <asp:GridView ID="GVICcap" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False"
                            CellPadding="3" AllowPaging="True"
                            DataKeyNames="idResumenDiario"
                            DataSourceID="EdsVistaIC"
                            OnDataBound="GVICcap_DataBound"
                            OnRowCommand="GVICcap_RowCommand"
                            OnRowDataBound="GVICcap_RowDataBound">
                            <Columns>
                               ...
                               <asp:BoundField DataField="MUNICIPIO" HeaderText="Municipio" SortExpression="MUNICIPIO"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="NombrePrograma" HeaderText="Progrma" SortExpression="NombrePrograma"></asp:BoundField>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaIC" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            <WhereParameters>
                                <asp:SessionParameter DefaultValue="" Name="resp" SessionField="responsable" Type="Int32" />
                            </WhereParameters>
                        </asp:EntityDataSource>

                        <%--administrador--%>
                        <asp:GridView ID="GvICadmin" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False"
                            CellPadding="3" AllowPaging="True"
                            DataKeyNames="idResumenDiario"
                            DataSourceID="EdsVistaICAdmin"
                            OnDataBound="GvICadmin_DataBound"
                            OnRowCommand="GvICadmin_RowCommand"
                            OnRowDataBound="GvICadmin_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="FolioActividad" HeaderText="Folio" HeaderStyle-CssClass="col-md-1" SortExpression="FolioActividad"></asp:BoundField>
                                <asp:BoundField DataField="fecha" HeaderText="fecha" SortExpression="fecha" DataFormatString="{0:dddd-dd-MMMM-yyyy}"></asp:BoundField>
                               <asp:BoundField DataField="MUNICIPIO" HeaderText="Municipio" SortExpression="MUNICIPIO"></asp:BoundField>
                            ...
                            <PagerTemplate>
                                <div class="row" style="margin-top: 20px;">
                                    ...
                                    <div class="col-lg-10" style="text-align: right;">
                                        <h3>
                                            <asp:Label ID="CurrentPageLabelt" runat="server" CssClass="label label-success" /></h3>
                                    </div>
                                </div>
                            </PagerTemplate>
                        </asp:GridView>
                        <asp:EntityDataSource runat="server" ID="EdsVistaICAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            EnableFlattening="False" EntitySetName="Wv_DatosReportesHistorico"
                            OrderBy="it.[fecha] desc" Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.programasID = 12) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                            <WhereParameters>
    ...
    <script type="text/javascript">
        ...
        function ConsultaHombresXacciones() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura.aspx/ChartDataNorteAccionesta")%>',
                data: "{'x': '" + x + "'}",
        ...
        function ConsultaMuniNorte() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura.aspx/datoGraficabarteNorteMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionescentroTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura.aspx/ChartDataCentroAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunicentro() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura.aspx/datoGraficabarteCentroMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionesSurTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura.aspx/ChartDataSurAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunisur() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Fomento_a_la_Prevyencion_a_traves_del_Deporte_Cultura.aspx/datoGraficabartesurMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
