<%@ Page Title="REDES VECINALES" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vistaInforme_Redes_vecinales.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.vistaInforme_Redes_vecinales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">REDES VECINALES</h5>
                        </div>
                        <div class="link-me">
                        </div>
                    </div>
        ...
        <div class="well" style="background-color: white">
            ...
            <div class="row">
                <asp:UpdatePanel runat="server" ID="upd">
                    <ContentTemplate>
                        <asp:GridView ID="GVEPartiCiudadano" runat="server" CssClass="table table-condensed table-bordered" Visible="false"
                            CellPadding="3" AllowPaging="True"
                            AutoGenerateColumns="False" DataKeyNames="idResumenDiario" DataSourceID="EdsVistaEscolar" OnDataBound="GVEPartiCiudadano_DataBound"
                            OnRowCommand="GVEPartiCiudadano_RowCommand"
                            OnRowDataBound="GVEPartiCiudadano_RowDataBound">
                            <Columns>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaEscolar" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            Where="it.Personalid == @resp || it.nombrecompleto =='0' ">
                            <WhereParameters>
                                <asp:SessionParameter DefaultValue="xxxxxx" Name="resp" SessionField="responsable" Type="Int32" />
                            </WhereParameters>
                        </asp:EntityDataSource>
                        <%--grid de admin--%>
                        <asp:GridView ID="GvPCAdmin" runat="server" CssClass="table table-condensed table-bordered" Visible="false"
                            CellPadding="3" AllowPaging="True"
                            AutoGenerateColumns="False" DataKeyNames="idResumenDiario" DataSourceID="EdsVistaPCaAdmin" OnDataBound="GvPCAdmin_DataBound"
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaPCaAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            EnableFlattening="False" EntitySetName="Wv_DatosReportesHistorico"
                            OrderBy="it.[fecha] desc"
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.programasID = 8 ) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                            <WhereParameters>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBKNdB_BzlNlxf84AMZK6C_T7tzodsLpy4&callback=initMap" async="" defer=""></script>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="chart-container">
                                                            <div class="panel-body">
                                                                <div>
                                                                    <canvas id="ChartPastelNorte_Redes"></canvas>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="position: relative; width: 46vw">
                                                <div class="card table-1-card">
                                                    <div class="card-block">
                                                        <div class="chart-container">
                                                            <canvas id="myChartBarZonaNorte_redes "></canvas>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card table-1-card">
                                                    <div class="card-block">
                                                        ...
                                                        <div class="chart-container">
                                                            <div class="panel-body">
                                                                <div>
                                                                    <canvas id="ChartAccionesCnetro_redes"></canvas>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6" style="position: relative; width: 46vw">
                                                <div class="card table-1-card">
                                                    <div class="card-block">
                                                        <div class="chart-container">
                                                            <canvas id="ChartBar_Centro_muni_redes"></canvas>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        function ConsultaHombresXacciones() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vistaInforme_Redes_vecinales.aspx/ChartDataNorteAccionesta_redes")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                dataFilter: function (data) { return data; },
                success: LlenarGraficaAccionesNorte_Beneficiados,
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    alert("Alerta:" + textStatus + " : " + errorThrown);
                }
            });
            function LlenarGraficaAccionesNorte_Beneficiados(response) {
                var dato = response.d;
                if (dato == null) {
                    ...
                    var acciones_R = [];
                    var cantidadesTotal_r = [];
                    $.each(dato, function (inx, val) {
                        acciones_R.push(val.etiqueta_R);
                        cantidadesTotal_r.push(val.Cantidad_redes);

                    });

                    var ct = document.getElementById("ChartPastelNorte_Redes");
                    var ChartPastelNorte_Redes = new Chart(ct, {
                        type: 'doughnut',
                        data: {
                            labels: acciones_R,
                            datasets: [
                                {
                                    label: 'Acciones',
                                    data: cantidadesTotal_r,
                                    //borderColor: "#3e95cd",
                                    fill: false,
                                    backgroundColor: getRandomColor(cantidadesTotal_r.length),
        ...
        function ConsultaMuniNorte() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vistaInforme_Redes_vecinales.aspx/datoGraficabarteNorteMuni_redes")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                dataFilter: function (data) { return data; },
                success: LlenarGraficaAcciones_Muni_Norte,
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    alert("Alerta:" + textStatus + " : " + errorThrown);
                }
            });
            function LlenarGraficaAcciones_Muni_Norte(response) {
                var dato = response.d;
                if (dato == null) {
                    console.log("NO TRAJO DATOS");
                }
                    ...
                    var Muni_redes = [];
                    var cantidadesTotalMun_redes = [];
                    $.each(dato, function (inx, val) {
                        Muni_redes.push(val.Municipios_redes);
                        cantidadesTotalMun_redes.push(val.CantidadMuni_redes);

                    });
                    var ctx = document.getElementById("ChartBarNorteMuni_redes");
                    var cartBarMuniNorte = new Chart(ctx, {
                        type: 'bar',
                        data: {
                            labels: Muni_redes,
                            datasets: [
                                {
                                    ...
                                    data: cantidadesTotalMun_redes,
                                    fill: false,
                                    backgroundColor: getRandomColor(cantidadesTotalMun_redes.length),
                                    stack: 1
                                },
                            ]
                        },
        ...
        function AccionescentroTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vistaInforme_Redes_vecinales.aspx/ChartDataCentroAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                dataFilter: function (data) { return data; },
                success: LlenarGraficaAcciones_Centro,
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    alert("Alerta:" + textStatus + " : " + errorThrown);
                }
            });
            function LlenarGraficaAcciones_Centro(response) {
                var dato = response.d;
                if (dato == null) {
                    console.log("NO TRAJO DATOS");
                }
                    ...
                    console.log("SI ENTRÓ" + response);
                    var accionesCentro_redes = [];
                    var cantidadesTotalCentro_redes = [];
                    $.each(dato, function (inx, val) {
                        accionesCentro_redes.push(val.etiquetaRcentro_redes);
                        cantidadesTotalCentro_redes.push(val.Cantidadcentro_redes);

                    });

                    var xt = document.getElementById("ChartAccionesCnetro_redes");
                    var ChartAccionesCnetro_redes = new Chart(xt, {
                        type: 'doughnut',
                        data: {
                            labels: accionesCentro_redes,
                            datasets: [
                                {
                                    label: 'Acciones',
                                    data: cantidadesTotalCentro_redes,
                                    //borderColor: "#3e95cd",
                                    fill: false,
                                    backgroundColor: getRandomColor(cantidadesTotalCentro_redes.length),
                                    //borderColor: getRandomColor(cantidadesTotal.length)
        ...
        function ConsultaMunicentro() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vistaInforme_Redes_vecinales.aspx/datoGraficabarteCentroMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                dataFilter: function (data) { return data; },
                success: LlenarGraficaMuni_centro,
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    alert("Alerta:" + textStatus + " : " + errorThrown);
                }
            });
            function LlenarGraficaMuni_centro(response) {
                var dato = response.d;
                if (dato == null) {
                    console.log("NO TRAJO DATOS");
                }
                    ...
                    var atrx = document.getElementById("ChartBar_Centro_muni_redes");
                    var ChartBar_Centro_muni_redes = new Chart(atrx, {
                        type: 'bar',
                        data: {
                            labels: Municentro,
                            datasets: [
        ...
        function AccionesSurTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vistaInforme_Redes_vecinales.aspx/ChartDataSurAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
            ...
            function LlenarGraficaAccionesZonaSur(response) {
                ...
                if (dato == null) {
                    ...
                    var apr = document.getElementById("myChartAccioneSur");
                    var myChartAccioneSur = new Chart(apr, {
                        type: 'doughnut',
                        data: {
                            labels: accionesSur,
                            datasets: [
        ...
        function ConsultaMunisur() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vistaInforme_Redes_vecinales.aspx/datoGraficabartesurMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
            ...
            function LlenarGraficaMuniZonaSur(response) {
                ...
                if (dato == null) {
                    ...
                    var npr = document.getElementById("myChartBarSur");
                    var myChartBarSur = new Chart(npr, {
                        type: 'bar',
                        data: {
                            labels: Munisur,
                            datasets: [
