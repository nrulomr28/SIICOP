<%@ Page Title="Vista de datos de la DGTSV" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vista_de_datos_de_actividades_DGTSV.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.DGTSV.Vista_de_datos_de_actividades_DGTSV" %>
        ...
        <div class="row">
            <div id="sidebar">
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            <h1>VISTA DE RESÚMENES DE DGTSV</h1>
                ...
                <asp:UpdatePanel runat="server" ID="upd">
                    <ContentTemplate>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaPCaAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) and (it.Dependencia == 'DGTSV' )  AND
                            ...
                            $.getJSON(url, function (data) {
                                ...
                                for (f; f < data.Puntos.length; f++) {
                                    ...
                                    switch (data.Puntos[f].id) {
                                        case 21:
                                            imgTipoAlerta = "../../Imagenes/Banner/DGTSV/Pin/Pin.png";
                                            break;
