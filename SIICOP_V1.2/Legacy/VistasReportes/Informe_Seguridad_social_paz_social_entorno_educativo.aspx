<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Informe_Seguridad_social_paz_social_entorno_educativo.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.Informe_Seguridad_social_paz_social_entorno_educativo" %>
   ...
   <link href="../Content/StyleGraficasprogra.css" rel="stylesheet" />
                ...
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">SEGURIDAD CIUDADANA Y PAZ SOCIAL EN ENTORNO EDUCATIVO   </h5>
                        </div>
                        <div class="link-me">
                        </div>
                    </div>
    ...
    <div class="container-fluid">
        <div class="well" style="background-color: white">
            <div class="row">
                ...
                <div id="RESPONSA" runat="server">
                    ...
                    <div class="col-lg-2">
                        ...
                        <asp:LinkButton ID="btnBuscar" runat="server" CssClass="btn btn-primary" Text="Buscar" OnClick="btnBuscar_Click"><span class="glyphicon glyphicon-search"></span>&nbsp;Buscar</asp:LinkButton>
                    </div>
            ...
            <asp:UpdatePanel runat="server" ID="upd">
                <ContentTemplate>
                    <asp:GridView ID="GvEscolarCap" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False" Visible="true"
                        CellPadding="3" AllowPaging="True"
                        DataKeyNames="idResumenDiario" DataSourceID="EdsVistaEscolar"
                        OnDataBound="GvEscolarCap_DataBound"
                        OnRowCommand="GvEscolarCap_RowCommand"
                        OnRowDataBound="GvEscolarCap_RowDataBound">
                        <Columns>
                    ...
                    <asp:EntityDataSource runat="server" ID="EdsVistaEscolar" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                        ...
                        Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.Personalid == @resp || it.nombrecompleto =='0' && it.programasID = 9) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                        <WhereParameters>
                    ...
                    <asp:GridView ID="GvAdminEscolar" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False" Visible="false"
                        CellPadding="3" AllowPaging="True"
                        DataKeyNames="idResumenDiario" DataSourceID="EdsVistaEscolarAdmin"
                        OnDataBound="GvAdminEscolar_DataBound"
                        OnRowCommand="GvAdminEscolar_RowCommand"
                        OnRowDataBound="GvAdminEscolar_RowDataBound">
                        <Columns>
                                <asp:BoundField DataField="FolioActividad" HeaderText="Folio" HeaderStyle-CssClass="col-md-1" SortExpression="FolioActividad"></asp:BoundField>
                    ...
                    <asp:EntityDataSource runat="server" ID="EdsVistaEscolarAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                        EnableFlattening="False" EntitySetName="Wv_DatosReportesHistorico" OrderBy="it.[fecha] desc"
                        Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.programasID = 9) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                        <WhereParameters>
                            <asp:SessionParameter DefaultValue="0" Name="resp" SessionField="responsable" DbType="Int32" />
                            <asp:SessionParameter SessionField="fInicialC" Name="fInicialC" Type="DateTime" />
                            <asp:SessionParameter SessionField="fFinalC" Name="fFinalC" Type="DateTime" />
    ...
    <script type="text/javascript">
        ...
        function ConsultaHombresXacciones() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Informe_Seguridad_social_paz_social_entorno_educativo.aspx/ChartDataNorteAccionesta")%>',
                data: "{'x': '" + x + "'}",
        ...
        function ConsultaMuniNorte() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Informe_Seguridad_social_paz_social_entorno_educativo.aspx/datoGraficabarteNorteMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionescentroTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Informe_Seguridad_social_paz_social_entorno_educativo.aspx/ChartDataCentroAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunicentro() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Informe_Seguridad_social_paz_social_entorno_educativo.aspx/datoGraficabarteCentroMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionesSurTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Informe_Seguridad_social_paz_social_entorno_educativo.aspx/ChartDataSurAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunisur() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Informe_Seguridad_social_paz_social_entorno_educativo.aspx/datoGraficabartesurMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
