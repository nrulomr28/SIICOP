<%--<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registro_de_poblacion_asistida.aspx.cs" Inherits="SIICOP_V1._2.Captura.DGPRS.Registro_de_poblacion_asistida" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registro_de_poblacion_asistida.aspx.cs" Inherits="SIICOP_V1._2.Captura.Captura_Dependencias" %>


<asp:Content ID="contenedorDGPRS" ContentPlaceHolderID="MainContent" runat="server">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <asp:EntityDataSource runat="server" ID="edsMunicipios" DefaultContainerName="SIICOBEntities" ConnectionString="name=SIICOBEntities" EnableFlattening="False" EntitySetName="Municipios">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <asp:EntityDataSource runat="server" ID="edsLocalidades" DefaultContainerName="SIICOBEntities" ConnectionString="name=SIICOBEntities" EnableFlattening="False" EntitySetName="Localidades"
                                        ...
                                        <asp:UpdatePanel runat="server" ID="udpCATALOGOS">
                                            <ContentTemplate>
                                                ...
                                                <fieldset class="group-border form-group-sm">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group form-group-sm col-md-5">
                                                            ...
                                                            <div class='input-group ' id='date2'>
                                                                ...
                                                                <asp:EntityDataSource runat="server" ID="edsEscuelaSegura" DefaultContainerName="SIICOBEntities"
                                                                    ConnectionString="name=SIICOBEntities" EnableFlattening="False" EntitySetName="TB_subprograma"
                                                        ...
                                                        <div class="form-group form-group-sm col-md-5">
                                                            ...
                                                            <div class='input-group ' id='date4'>
                                                                ...
                                                                <asp:EntityDataSource runat="server" ID="edsAcciones" DefaultContainerName="SIICOBEntities" ConnectionString="name=SIICOBEntities" EnableFlattening="False" EntitySetName="Cat_Acciones"
                                                                    Where="it.AccionesId IN {1078,1079,1080,1081,1082,1083,1084}">
                                                                </asp:EntityDataSource>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label for="exampleInputEmail1">Requerimientos o solicitudes</label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div  runat="server">
                                                                <label for="exampleInputEmail1">Responsable de la platica de los servicios del c4</label>
    ...
    <div class="modal fade" id="ModalGuardarexito" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:LinkButton runat="server" CssClass="btn btn-success" ID="lkbtSalirReporte">Aceptar</asp:LinkButton>
    ...
    <div class="modal" tabindex="-1" id="modalFOlio" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:LinkButton runat="server" CssClass="btn btn-success" ID="btnaceptar">Aceptar</asp:LinkButton>
