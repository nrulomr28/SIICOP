<%@ Page Title="Construción de una cultura incluyente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Construccion_Cultura_Incluyente.aspx.cs" Inherits="SIICOP_V1._2.Captura.Construccion_Cultura_Incluyente" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%--<script src="<%= ResolveUrl("Scripts/validalor.js") %>" type="text/javascript"></script>--%>
    <script src="../Scripts/validalor.js"></script>
    <br />
    <br />
                    ...
                    <div class="sosmed">
                        <div class="user">
                            ...
                            <div class="user-head">
                                ...
                                <h5 style="color: #feff00">CONSTRUCCIÓN DE UNA 
                                <br>
                                    CULTURA INCLUYENTE</h5>
                            </div>
                            <div class="link-me">
                                <div class="hr-center"></div>
                            </div>
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class='input-group date' id='datetimepicker1'>
                                                            <asp:TextBox runat="server" ID="txtFecha" CssClass="form-control" autocomplete="off" placeholder="dd/mm/aaaa" OnTextChanged="txtFecha_TextChanged"   AutoPostBack="true"/>
                                                        ...
                                                        <div class="form-group form-group-sm col-md-5">
                                                            ...
                                                            <div class='input-group ' id='date2'>
                                                                ...
                                                                <asp:EntityDataSource runat="server" ID="edsEscuelaSegura" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities" EnableFlattening="False" EntitySetName="TB_subprograma"
                                                                    Where="it.ProgramaCompartidoID = 7">
                                                                </asp:EntityDataSource>
                                                            </div>
                                                        ...
                                                        <div class="form-group form-group-sm col-md-5">
                                                            ...
                                                            <div class='input-group ' id='date4'>
                                                                ...
                                                                <asp:EntityDataSource runat="server" ID="edsAcciones" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities" EnableFlattening="False" EntitySetName="Cat_Acciones"
                                                                    AutoGenerateWhereClause="false"     Where="it.IdPrograma = 7">
                                                                  <%--  <WhereParameters>
                                            ...
                                            <div class="container">
                                                <div class="span9">
                                                    <div class="form-horizontal">
                                                        <div class="row">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Niños</label>
                                                                <div class="col-md-2">
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Niñas</label>
                                                                <div class="col-md-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Hombres con discapacidad</label>
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='docenteh'>
                                                                        <input type="text" id="txtdocenteh" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                        <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                        <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Mujeres con discapacidad</label>
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='docentem'>
                                                                        <input type="text" id="txtdocentem" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                        <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                        <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Hombres indígenas</label>
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='Hindigenas'>
                                                                        <input type="text" id="txtHindigenas" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                        <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                        <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Mujeres indígenas</label>
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='Mindigenas'>
                                                                        <input type="text" id="txtMindigenas" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                        <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                        <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                    </div>
                                                                </div>
