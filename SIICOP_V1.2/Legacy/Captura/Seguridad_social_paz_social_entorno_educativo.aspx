<%@ Page Title="Seguridad ciudadana y paz social en entornos educativos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Seguridad_social_paz_social_entorno_educativo.aspx.cs" Inherits="SIICOP_V1._2.Captura.EscuelaSegura" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="sosmed">
                        <div class="user">
                            ...
                            <div class="user-head">
                                ...
                                <h5 style="color: #feff00">SEGURIDAD CIUDADANA Y PAZ
                                <br>
                                    SOCIAL EN ENTORNO EDUCATIVO</h5>
                            </div>
                            <div class="link-me">
                                <div class="hr-center"></div>
                            </div>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <fieldset class="group-border form-group-sm">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-10">Nombre del la escuela</label>
