...
{
    public partial class Ficha_idetificacion_diaria : System.Web.UI.Page
    {
        ...
        protected void expediente_Llenar(Guid idExpediente)
        {
            ...
            if (datosGralReporte != null)
            {
                ...
                this.txtsolicitudes.Text = datosGralReporte.Requerimeintos != null ? datosGralReporte.Requerimeintos : "";
            ...
            else
            {
                ...
                try
                {
                    ...
                    ctx.TB_DatosGralReporte.Add(new TB_DatosGralReporte()
                    {
                        ...
                        Requerimeintos = this.txtsolicitudes.Text == string.Empty ? "" : this.txtsolicitudes.Text.ToUpper(),
                    ...
                    tbAuditoria audit = new tbAuditoria()
                    {
                        ...
                        Descripcion = "Nuevo registro de reporte de actividades DGTSV",
        ...
        protected void btnaceptar_Click(object sender, EventArgs e)
        {
            ...
            this.Session["idPrograma_Accion"] = (object)null;
            this.Session["ProgramaId"] = (object)null;
            this.Response.Redirect("~/VistasReportes/DGTSV/Vista_de_datos_de_actividades_DGTSV.aspx");
            this.HiddenField1.Value = (string)null;
            this.btnGuardarEdicion.Visible = false;
            this.btnSalir.Visible = false;
        }
        ...
        protected void btnGuardarEdicion_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (datosGralReporte != null)
                {
                    ...
                    datosGralReporte.Requerimeintos = this.txtsolicitudes.Text == string.Empty ? "" : this.txtsolicitudes.Text.ToUpper();

                }
                else
                    ctx.TB_DatosGralReporte.Add(new TB_DatosGralReporte() //// tabla general del reporte 
                ...
                tbAuditoria entity = new tbAuditoria()
                {
                    ...
                    PagModificacion = this.Page.Title,
                    Descripcion = "Se edito el registro de reporte de actividades ,DGTSV",
                    usuario = this.txtResponsable.Text,
                ...
                this.Session["idPrograma_Accion"] = (object)null;
                Session["subpro"] = null;
                ScriptManager.RegisterStartupScript((Page)this, this.GetType(), "redirect", "alert('DATOS GUARDADOS CON EXITO'); window.location='" + this.Request.ApplicationPath + "Bienvenido_DGTSV.aspx';", true);
