<%@ Page Title="Redes vecinales" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Redes_vecinales.aspx.cs" Inherits="SIICOP_V1._2.Captura.PrevencionVecinal" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCMxnyTQiOuQo9DY4TjsWzZlkwzTgxaTEM&libraries=places&callback=initMap" async defer></script>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <%-- <button type="button" class="btn btn-lg  btn-success btn-block" onclick="openModal();" id="btnGuardar" runat="server" visible="false">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <div style="width: 50%; margin: 0 auto; text-align: center">
                    <div class="">
                        <a href="http://repositorio.veracruz.gob.mx/seguridad/wp-content/uploads/sites/16/2019/04/Ley-Número-316-Protección-de-Datos-Personales-en-Posesión-de-Sujetos-Obligados-para-el-Estado-de-Veracruz-de-Ignacio-de-la-Llave..pdf">
                            <i class="fa fa-book" style="font-size: 6.3em; color: #820e2e"></i></a>
                    </div>
                    <div class="caption">
                        <h6 style="text-align: center">Ley 316 de Protección de</h6>
                        <h6 style="text-align: center">Datos Personales en</h6>
                        <h6 style="text-align: center">Posesión de Sujetos Obligados</h6>
                    </div>
                </div>
                &nbsp;
            </div>
            ...
            <div class="col-sm-6 col-md-3">
                <div style="width: 50%; margin: 0 auto; text-align: center">
                    <div class="">
                        <a href="http://www.veracruz.gob.mx/seguridad/avisos-de-privacidad-y-sistemas-de-datos-personales-de-las-diferentes-areas">
                            <i class="fas fa-shield-alt" style="font-size: 6.3em; color: #820e2e"></i></a>
                    </div>
                    <div class="caption">
                        <h6 style="text-align: center">Avisos de Privacidad Integrales</h6>
                    </div>
                </div>
                &nbsp;
            ...
            <div class="col-sm-6 col-md-3">
                <div style="width: 50%; margin: 0 auto; text-align: center">
                    <div class="">
                        <a href="http://repositorio.veracruz.gob.mx/seguridad/wp-content/uploads/sites/16/2023/01/FORMATO-ARCO-2023.pdf">
                            <i class="fa fa-clipboard" style="font-size: 6.3em; color: #820e2e"></i></a>
                    </div>
                    <div class="caption">
                        <h6 style="text-align: center">Formato para Solicitud de ejercicio de los derechos ARCO</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-6 col-md-3">
        <div style="width: 50%; margin: 0 auto; text-align: center">
            <div class="">
                <a href="http://www.veracruz.gob.mx/seguridad/actas-de-comite-de-transparencia/">
                    <i class="fa fa-id-card" style="font-size: 6.3em; color: #820e2e"></i></a>
            </div>
            <div class="caption">
                <h6 style="text-align: center">Actas de Comité de Transparencia del Sistema de Gestión</h6>
            </div>
        </div>
        &nbsp;
