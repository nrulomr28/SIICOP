<%@ Page Title="Fortalecimiento_Emocional" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Fortalecimiento_Emocional.aspx.cs" Inherits="SIICOP_V1._2.Captura.Fortalecimiento_Emocional" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="sosmed">
                    <div class="user">
                        ...
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">PROTECTORES DE VIDA   
                                <br>
                               CONTRA LAS ADICCIONES </h5>
                        </div>
                        <div class="link-me">
                            <div class="hr-center"></div>
                        </div>
                                          ...
                                          <div class="row"> 
                                                   <div class="col-md-5">                                                                          
                                                       <label for="exampleInputEmail1">Lugar donde se realizó la actividad</label>
                                                         <div class='input-group ' id='lugar'>
                                              ...
                                              <div class="form-group form-group-sm col-md-3">
                                                    ...
                                                    <div class="form-group form-group-sm col-md-4">
                                                        ...
                                                        <div class='input-group ' id='ambito'>
                                                            <asp:DropDownList runat="server" ID="ddlAmbito" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlAmbito_SelectedIndexChanged">
                                                                <asp:ListItem Value="0">--Seleccione--</asp:ListItem>
                                                                <asp:ListItem Value="1">Escolar</asp:ListItem>
                                                                <asp:ListItem Value="2">Empresarial</asp:ListItem>
                                                                <asp:ListItem Value="3">Comunitario</asp:ListItem>                                                                
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div> 
                                                     <div runat="server" id="Escuela" visible="false">
                                                                 <div class="row">
                                                                  <div class="form-group form-group-sm col-md-4">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <small class="text-muted">
                                                     Caracteres restantes: <span id="charsLeft">300</span>
                                                 </small>
                                                    </div>
                                                </div>
                                                <br />
                                    ...
                                    <ContentTemplate>
                                        <div class="container-fluid">
                                            <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Niños</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='Nino'>
                                                                    <input type="text" id="txnino" class="montoH" onkeyup="sumarH();" runat="server" cssclass="form-control" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Niñas</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='niña'>
                                                                    <input type="text" id="txnina" class="montoM" onkeyup="sumarM();" runat="server" cssclass="form-control" />
                                                    ...
                                                    <div class="col-md-6">
                                                    <div class="form-group form-group-sm">
                                                        <label class="col-md-5 control-label">Hombres</label>
                                                        <div class="col-md-3">
                                                            <div class='input-group date' id='hombres'>
                                                                <input type="text" id="txhombres" class="montoH" onkeyup="sumarH();" runat="server" cssclass="form-control" />
                                                                <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                    <div class="form-group form-group-sm">
                                                        <label class="col-md-5 control-label">Mujeres</label>
                                                        <div class="col-md-3">
                                                            <div class='input-group date' id='mujeres'>
                                                                <input type="text" id="txmujeres" class="montoM" onkeyup="sumarM();" runat="server" cssclass="form-control" />
                                                                <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                            </div>
                                                        </div>
                                               ...
                                               <div class="col-md-6">
                                                 <div class="form-group form-group-sm">
                                                     <label class="col-md-5 control-label">Total Hombres</label>
                                                     <div class="col-md-3">
                                                         <div class='input-group date' id='Thombres'>                                                               
                                                             <asp:TextBox ID="txtatendiosH" runat="server" CssClass="form-control"
                                                                 Enabled="true" 
                                                                 placeholder="0"
                                                                 Width="170px" >
                                                             </asp:TextBox> 
                                             ...
                                             <div class="col-md-6">
                                                  <div class="form-group form-group-sm">
                                                      <label class="col-md-5 control-label">Total Mujeres</label>
                                                      <div class="col-md-3">
                                                          <div class='input-group date' id='TMujeres'>                                                            
