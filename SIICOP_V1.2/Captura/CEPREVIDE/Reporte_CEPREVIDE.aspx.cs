...
namespace SIICOP_V1._2.Captura.CEPREVIDE
{
    public partial class Reporte_CEPREVIDE : System.Web.UI.Page
    {
        ...
        {
            /// función para validar el tipo de usuario que esta ingresando
            if (!IsPostBack)
            {
            ...
            if (Session["idReporte_Accion"] != null && Session["AccionReporte"] != null)
            {
                ...
                switch ((int)accion)
                {
                    case (int)AccionReporte.Creacion:
                        ...
                        {
                            this.Response.Redirect("~/MenuProgramas/CREPREVIDE/Programa_CEPREVIDE.aspx");
                        }
                        break;
        ...
        protected void lnkbtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (idPrograma == 23)
            {
                claveF = "ESC-CEPREVIDE";
            }
            if (idPrograma == 24)
            {
                claveF = "GRV-CEPREVIDE";
            }
            if (idPrograma == 25)
            {
                claveF = "CyLD-CEPREVIDE";
            }
            if (idPrograma == 26)
            {
                claveF = "REP-CEPREVIDE";
            }
            ...
            else
            {
                ...
                try
                {
                    ...
                    tbAuditoria audit = new tbAuditoria()
                    {
                        ...
                        Descripcion = "Nuevo registro de reporte de actividades CEPREVIDE",
        ...
        protected void btnaceptar_Click(object sender, EventArgs e)
        {
            ...
            this.Response.Redirect("~/VistasReportes/CEPREVIDE/Vista_de_datos_de_actividades_CEPREVIDE.aspx");
        ...
        protected void btnGuardarEdicion_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                tbAuditoria entity = new tbAuditoria()
                {
                    ...
                    PagModificacion = this.Page.Title,
                    Descripcion = "Se edito el registro de reporte de actividades ,CEPREVIDE",
                    usuario = this.txtResponsable.Text,
                ...
                this.Session["idPrograma_Accion"] = (object)null;
                Session["subpro"] = null;
                ScriptManager.RegisterStartupScript((Page)this, this.GetType(), "redirect", "alert('DATOS GUARDADOS CON EXITO'); window.location='" + this.Request.ApplicationPath + "Bienvenido_CEPREVIDE.aspx';", true);
