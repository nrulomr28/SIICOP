...
{
    public partial class ForosFerias : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (User.IsInRole("SYSADMIN") || User.IsInRole("Foráneo") || User.IsInRole("Cap_FF") || User.IsInRole("Administrador") || User.IsInRole("Inclusión_Social")
                    || User.IsInRole("CapSEMP") || User.IsInRole("Admin_Empresarial") || User.IsInRole("CapEscolar") || User.IsInRole("Admin_Escolar")
                    || User.IsInRole("Cap_PVM") || User.IsInRole("Admin_PVM")
                     || User.IsInRole("Cap_PC") || User.IsInRole("Admin_PC") || User.IsInRole("Admin_FDC"))
                {
            ...
            if (Session["idExpediente_Accion"] != null && Session["AccionExpediente"] != null)
            {
                ...
                switch ((int)accion)
                {
                    case (int)AccionExpediente.Creacion:
                        if (!User.IsInRole("SysAdmin") && !User.IsInRole("Foraneo") && !User.IsInRole("Cap_FF") && !User.IsInRole("Administrador"))
                        {
        ...
        protected void btnGuardarEdicion_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                tbAuditoria entity = new tbAuditoria()
                {
                    ...
                    Descripcion = "Se edito el registro de reporte de actividades ,Encuentros Ciudadanos por la Seguridad",
            ...
            else
            {
                ...
                try
                {
                    ...
                    tbAuditoria audit = new tbAuditoria()
                    {
                        ...
                        PagModificacion = this.Page.Title,
                        Descripcion = "Nuevo registro de reporte de actividades ,Encuentros Ciudadanos por la Seguridad",
                        usuario = this.txtResponsable.Text,
