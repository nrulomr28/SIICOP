...
{
    public partial class PrevenciondelaVM : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (User.IsInRole("SysAdmin") || User.IsInRole("Foráneo") || (this.User.IsInRole("Administrador") || User.IsInRole("Cap_PVM") || User.IsInRole("Admin_PVM")))
                {
            ...
            if (Session["idExpediente_Accion"] != null && Session["AccionExpediente"] != null)
            {
                ...
                switch ((int)accion)
                {
                    case (int)AccionExpediente.Creacion:
                        if (!this.User.IsInRole("SysAdmin") && !this.User.IsInRole("Cap_PVM") && (!this.User.IsInRole("Administrador") && !this.User.IsInRole("Admin_PVM")))
                        {
                            Response.Redirect("~/VistasReportes/VistaPrevencionVM.aspx");
                        }
                        break;
        ...
        #region ### METODO PARA LLENAR , GUARDAR , EDITAR Y DATOS
        ...
        protected void btnGuardarEdicion_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                tbAuditoria entity = new tbAuditoria()
                {
                    ...
                    Descripcion = "Se edito el registro de reporte de actividades ,Prevención de la Violencia por Razones de Género",
            ...
            else
            {
                ...
                try
                {
                    ...
                    tbAuditoria audit = new tbAuditoria()
                    {
                        ...
                        PagModificacion = this.Page.Title,
                        Descripcion = "Nuevo registro de reporte de actividades ,Prevención de la Violencia por Razones de Género",
                        usuario = this.txtResponsable.Text,
        ...
        #region #### METODO PARA DATABOUN DE LOS DropDownList
