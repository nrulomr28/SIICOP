<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx.cs" Inherits="SIICOP_V1._2.Captura.Redes_Veracruzanas_en_la_Construccion_de_la_Paz" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="sosmed">
                    <div class="user">
                        ...
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">REDES VERACRUZANAS AN LA 
                                <br>
                                CONSTRUCCIÓN DE LA PAZ</h5>
                        </div>
                        <div class="link-me">
                            <div class="hr-center"></div>
                        </div>
                                    ...
                                    <asp:UpdatePanel ID="UpdRegionesMuni" runat="server">
                                        <ContentTemplate>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group form-group-sm">
                                                        <label class="col-md-3">Región</label>
                                                        <asp:DropDownList runat="server" ID="ddlRegion" CssClass="form-control" DataSourceID="edsRegion" DataTextField="RegionNombre" DataValueField="RegionID" AutoPostBack="true"
                                                            OnDataBound="ddlRegion_DataBound">
                                                        </asp:DropDownList>
                                                        <asp:EntityDataSource runat="server" ID="edsRegion" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities" EnableFlattening="False" EntitySetName="Cat_Region"></asp:EntityDataSource>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-group-sm">
                                                        ...
                                                        <asp:DropDownList CssClass="form-control" ID="ddlDelegacion" runat="server" DataSourceID="edsDelegacion" DataTextField="DelegacionNombre" DataValueField="DelegacionID" AutoPostBack="true" OnDataBound="ddlDelegacion_DataBound">
                                                        </asp:DropDownList>
                                                        <asp:EntityDataSource runat="server" ID="edsDelegacion" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities" EnableFlattening="False" EntitySetName="Cat_Delegacion"
                                                            AutoGenerateWhereClause="True">
                                                            <WhereParameters>
                                                                <asp:ControlParameter ControlID="ddlRegion" DbType="Int32" Name="RegionID" PropertyName="SelectedValue" DefaultValue="" />
                                                            </WhereParameters>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-group-sm">
                                                        ...
                                                        <asp:DropDownList runat="server" ID="ddlMuNICIPIO" CssClass="form-control" DataSourceID="edsMunicipios" DataTextField="MUNICIPIO" DataValueField="MunicipioID" AutoPostBack="true" OnDataBound="ddlMuNICIPIO_DataBound">
                                                        </asp:DropDownList>
                                                        <asp:EntityDataSource runat="server" ID="edsMunicipios" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities" EnableFlattening="False" EntitySetName="Municipios"
                                                            AutoGenerateWhereClause="True">
                                                            <WhereParameters>
                                                                <asp:ControlParameter ControlID="ddlDelegacion" DbType="Int32" Name="DelegacionID" PropertyName="SelectedValue" DefaultValue="" />
                                                            </WhereParameters>
                                                        </asp:EntityDataSource>
                                                    </div>
                                                </div>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <fieldset class="group-border form-group-sm">
                                                    ...
                                                    <div class="form-group form-group-sm col-md-5">
                                                        ...
                                                        <div class='input-group ' id='date4'>
                                                            ...
                                                            <asp:EntityDataSource runat="server" ID="edsAcciones" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities" EnableFlattening="False" EntitySetName="Cat_Acciones"
                                                                Where="it.IdPrograma = 14">
                                                            </asp:EntityDataSource>
                                                        </div>
                                                    </div>
                                                    <%--    Where="it.AccionesID =1067 || it.AccionesID =1068|| it.AccionesID =1069|| it.AccionesID =1070|| it.AccionesID =1071 || it.AccionesID =1156  || it.AccionesID =1157">--%>
                                                </div>
                                                <br />
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group form-group-sm col-md-4">
                                                        <label for="exampleInputEmail1">Ámbito</label>
                                                        <div class='input-group ' id='date5'>
                                                            <asp:DropDownList runat="server" ID="ddlAmbito" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlAmbito_SelectedIndexChanged">
                                                                ...
                                                                <asp:ListItem Value="1">Educativo</asp:ListItem>
                                                                <asp:ListItem Value="2">Empresarial</asp:ListItem>
                                                                <asp:ListItem Value="3">Ciudadanía</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <asp:UpdatePanel ID="updBeneficiados" runat="server">
                                    <ContentTemplate>
                                        <div class="container-fluid">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" runat="server" id="alumnos" visible="false">

                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Alumnos H</label>
                                                            <div class="col-md-1">
                                                                <div class='input-group date' id='Nino'>
                                                                    <input type="text" id="txnino" runat="server" cssclass="form-control" class="monto" onkeyup="sumar();" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Alumnas M</label>
                                                            <div class="col-md-1">
                                                                <div class='input-group date' id='niña'>
                                                                    <input type="text" id="txnina" onkeyup="sumar();" runat="server" cssclass="form-control" class="monto" />
                                                ...
                                                <div class="row" runat="server" id="Padres" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Padres</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='padres'>
                                                                    <input type="text" id="txhombres" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Madres</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='Mujeres'>
                                                                    <input type="text" id="txmujeres" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row" runat="server" id="docentes" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Docentes H</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docenteh'>
                                                                    <input type="text" id="txdocenteh" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Docentes M</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docentem'>
                                                                    <input type="text" id="txdocentem" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row" runat="server" id="otros" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Otros H</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docenteh'>
                                                                    <input type="text" id="txOtrosH" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Otros M</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docentem'>
                                                                    <input type="text" id="txOtrosM" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row" runat="server" id="Empresario" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Empresarial H</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='Nino'>
                                                                    <input type="text" id="txEmpresarialH" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Empresarial M</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='niña'>
                                                                    <input type="text" id="txEmpresarialM" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="row" runat="server" id="Agremiados" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Agremiados H</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='padres'>
                                                                    <asp:TextBox ID="txtAgremiadoH" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number"></asp:TextBox>
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Agremiados M</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='Mujeres'>
                                                                    <asp:TextBox ID="txtAgremiadoM" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number"></asp:TextBox>
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row" runat="server" id="PrecidenteMuni" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Precidente Municipal H</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docenteh'>
                                                                    <asp:TextBox ID="txtpredicenteH" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number"></asp:TextBox>
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Precidente Municipal M</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docentem'>
                                                                    <asp:TextBox ID="txtpredicenteM" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number"></asp:TextBox>
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row" runat="server" id="Ciudadanos" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Ciudadanos H</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docenteh'>
                                                                    <input type="text" id="txCiudadanoH" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Ciudadanos M</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docentem'>
                                                                    <input type="text" id="txCiudadanoM" class="monto" onkeyup="sumar();" runat="server" cssclass="form-control" />
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row" runat="server" id="Actores" visible="false">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Actores sociales H</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docenteh'>
                                                                    <asp:TextBox ID="txtActoresH" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number"></asp:TextBox>
                                                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-sm">
                                                            <label class="col-md-5 control-label">Actores sociales M</label>
                                                            <div class="col-md-3">
                                                                <div class='input-group date' id='docentem'>
                                                                    <asp:TextBox ID="txtActoresM" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number"></asp:TextBox>
                                                                    <span class="input-group-addon"><i class="fa fa-female" aria-hidden="true" style="color: #820E2E"></i></span>
                                                                    <span class="badge" style="background-color: white; color: red" data-toggle="tooltip" data-placement="right" title="Es obligatorio este campo">*</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class=" row">
                                                                ...
                                                                <div class=" col-xs-6 col-md-4">
                                                                    <asp:TextBox ID="txtatendios" runat="server" CssClass="form-control" Enabled="true" placeholder="0"></asp:TextBox>
                            ...
                            <div class="timeline-panel">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <asp:FileUpload CssClass="file" runat="server" ID="file" AllowMultiple="false" type="file" date-min-file-count="1" />
