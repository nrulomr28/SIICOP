<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Captura_Dependencias.aspx.cs" Inherits="SIICOP_V1._2.Captura.Captura_Dependencias" %>
                    ...
                    <div class="sosmed">
                        <div class="user">
                            ...
                            <div class="user-head">
                                ...
                                <h5 style="color: #feff00" id="dependencia" runat="server">POR DEPENDENCIAS</h5>
                            </div>
                            <div class="link-me">
                                <div class="hr-center"></div>
                            </div>
                        ...
                        <ul class="timeline">
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-md-4">
                                                <div class='input-group date' id='datetimepicker1'>
                                                    <asp:TextBox runat="server" ID="txtFecha" CssClass="form-control" placeholder="dd/mm/aaaa" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <asp:DropDownList runat="server" ID="ddlLocalidad" CssClass="form-control" DataSourceID="edsLocalidades" DataTextField="Localidad" DataValueField="LocalidadID"
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group form-group-sm col-md-5">
                                                            ...
                                                            <div class='input-group ' id='date2'>
                                                                ...
                                                                <asp:DropDownList runat="server" ID="ddlsubprograma" CssClass="form-control" AutoPostBack="true">
                                                        ...
                                                        <div class="form-group form-group-sm col-md-5">
                                                            ...
                                                            <div class='input-group ' id='date4'>
                                                                <asp:DropDownList ID="ddlAcciones" runat="server" CssClass="form-control" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='TotaldeHombresatendidos'>
                                                                        <asp:TextBox ID="txttotlaHombres" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number" OnTextChanged="txttotlaHombres_TextChanged"></asp:TextBox>
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='TotaldeMujeresatendidos'>
                                                                        <asp:TextBox ID="txtmujer" runat="server" CssClass="form-control" placeholder="0" AutoPostBack="true" TextMode="Number" OnTextChanged="txtmujer_TextChanged"></asp:TextBox>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <asp:LinkButton runat="server" CssClass="btn btn-danger btn-block" Visible="false" ID="lnkbtnSalir" OnClick="lnkbtnSalir_Click">
                                                      <span class="fa fa-times" aria-hidden="true"></span> Salir Modo edición
                                            </asp:LinkButton>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <asp:LinkButton runat="server" CssClass="btn btn-warning btn-block" Visible="false" ID="lnkbtnGuardarEdicion" OnClick="lnkbtnGuardarEdicion_Click">
                                                      <span class="glyphicon glyphicon-floppy-saved" aria-hidden="true"></span> Guardar
                                                </asp:LinkButton>
