<%@ Page Title="Sector empresarial" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Enlace_con_el_Sector_Empresarial.aspx.cs" Inherits="SIICOP_V1._2.Captura.SectorEmpresarial" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="sosmed">
                        <div class="user">
                            ...
                            <div class="user-head">
                                ...
                                <h5 style="color: #feff00">ENLACE CON EL 
                                <br>
                                    SECTOR EMPRESARIAL</h5>
                            </div>
                            <div class="link-me">
                                <div class="hr-center"></div>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group form-group-sm col-md-5">
                                                            ...
                                                            <div class='input-group ' id='date4'>
                                                                <asp:DropDownList ID="ddlAcciones" runat="server" CssClass="form-control" DataSourceID="edsAcciones" DataTextField="AccionesNombre" DataValueField="AccionesID" AutoPostBack="true" OnSelectedIndexChanged="ddlAcciones_SelectedIndexChanged"
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-panel">
                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                            <ContentTemplate>
                                                                <div class="container" runat="server"  id="atendidos" visible="false">
                                                                    <div class="span9">
