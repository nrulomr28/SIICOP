...
{
    public partial class PrevencionVecinal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (User.IsInRole("SYSADMIN") || User.IsInRole("Foráneo") || User.IsInRole("Administrador") || User.IsInRole("Cap_PC") || User.IsInRole("Admin_Empresarial") || (this.User.IsInRole("Admin_PC")) || this.User.IsInRole("Admin_FDC"))
                {
        ...
        #region DETERMINACION DEL FORMULARIO YA SEA QUE SEA UNO NUEVO O QUE SE EDITE Y MUESTRE LOS DATOS 
            ...
            if (Session["idExpediente_Accion"] != null && Session["AccionExpediente"] != null)
            {
                ...
                switch ((int)accion)
                {
                    case (int)AccionExpediente.Creacion:
                        if (!this.User.IsInRole("SYSADMIN") && !this.User.IsInRole("Cap_PC") && (!this.User.IsInRole("Administrador") && !this.User.IsInRole("Admin_PC")) && !this.User.IsInRole("Admin_FDC"))
                        {
                            Response.Redirect("~/Captura/PrevencionVecinal.aspx");
                        }
                        break;
        ...
        protected void expediente_Llenar(Guid idExpediente)
        {
            ...
            if (reportesHistorico != null)
            {
                ...
                this.ddlsubprograma.SelectedValue = reportesHistorico.subprogramaId != null ? reportesHistorico.subprogramaId.ToString() : "";
                ddlsubprograma.DataBind();
                this.ddlAcciones.SelectedValue = reportesHistorico.AccionesID != 0 ? reportesHistorico.AccionesID.ToString() : "0";
            ...
            //tb_DireccionReporte donde van guardada las direcciones de google
        ...
        #region BOTON PARA GUARDAR NUEVO REPORTE, SALIR Y EDITAR
        ...
        protected void btnGuardarEdicion_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                tbAuditoria entity = new tbAuditoria()
                {
                    ...
                    Descripcion = "Se edito el registro de reporte de actividades ,Redes vecinales",
            ...
            else
            {
                ...
                try
                {
                    ...
                    tbAuditoria audit = new tbAuditoria()
                    {
                        ...
                        PagModificacion = this.Page.Title,
                        Descripcion = "Nuevo registro de reporte de actividades ,Redes vecinales",
                        usuario = this.txtResponsable.Text,
        ...
        //protected void btnGuardarprevenVecina_Click(object sender, EventArgs e)
        //{
