<%@ Page Title="Ficha diaria DGTSV" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ficha_idetificacion_diaria.aspx.cs" Inherits="SIICOP_V1._2.Captura.DGTSV.Ficha_idetificacion_diaria" %>
                    ...
                    <div class="sosmed">
                        <div class="user">
                            ...
                            <div class="user-head">
                                ...
                                <h5 style="color: #feff00">FICHA DIARIA
                                <br>
                                    DE IDENTIFICACIÓN DGTSV</h5>
                            </div>
                            <div class="link-me">
                                <div class="hr-center"></div>
                            </div>
                                        ...
                                        <asp:UpdatePanel runat="server" ID="udpCATALOGOS">
                                            <ContentTemplate>
                                                ...
                                                <fieldset class="group-border form-group-sm">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label for="exampleInputEmail1">Observaciones del curso-taller o instructores</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <asp:TextBox ID="txtsolicitudes" CssClass="form-control" runat="server" Height="60px" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <br />
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div id="Div1" runat="server">
                                                                <label for="exampleInputEmail1">Responsable de la capacitación de fomento y cultura vial</label>
                                            ...
                                            <div class="container">
                                                <div class="span9">
                                                    <div class="form-horizontal">
                                                        <div class="row">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Alumnos niños</label>
                                                                <div class="col-md-2">
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Alumnos niñas</label>
                                                                <div class="col-md-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Padres</label>
                                                                <div class="col-md-2">
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Madres</label>
                                                                <div class="col-md-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Docentes hombres</label>
                                                                <div class="col-md-2">
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Docentes mujeres</label>
                                                                <div class="col-md-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Empleados hombres</label>
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='docenteh'>
                                                                        <%--<asp:TextBox ID="txtdocenteh" runat="server" CssClass="form-control" placeholder="0" OnTextChanged="txtdocenteh_TextChanged" AutoPostBack="true" TextMode="Number"></asp:TextBox>--%>
                                                            ...
                                                            <div class="form-group form-group-sm">
                                                                <label class="col-md-2 control-label">Empleadas mujeres</label>
                                                                <div class="col-md-2">
                                                                    <div class='input-group date' id='docentem'>
                                                                        <%--<asp:TextBox ID="txtdocentem" runat="server" CssClass="form-control" placeholder="0" OnTextChanged="txtdocentem_TextChanged" AutoPostBack="true" TextMode="Number"></asp:TextBox>--%>
