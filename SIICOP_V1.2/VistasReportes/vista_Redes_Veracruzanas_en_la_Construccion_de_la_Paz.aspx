<%@ Page Title="REDES VERACRUZANAS EN LA CONSTRUCCIÓN DE LA PAZ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">REDES VERACRUZANAS EN LA CONSTRUCCIÓN DE LA PAZ</h5>
                        </div>
                        <div class="link-me">
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div id="RESPONSA" runat="server">
                                        ...
                                        <div class="col-lg-1" runat="server" id="bottonExcel" visible="false">
                                            ...
                                            <asp:LinkButton ID="lkbtnexcel" runat="server" CssClass="btn btn-success" Style="font-size: 1.8em" Text="excel" OnClick="lkbtnexcel_Click" title="Exportar"><span class="far fa-file-excel"></span>&nbsp;</asp:LinkButton>
                                        </div>
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    ...
                    <div class="well" style="background-color: white">
                        <asp:GridView ID="GvRedesPazCap" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False" Visible="true"
                            CellPadding="3" AllowPaging="True"
                            DataKeyNames="idResumenDiario" DataSourceID="EdsVistaRedesPaz"
                            OnDataBound="GvRedesPazCap_DataBound"
                            OnRowCommand="GvRedesPazCap_RowCommand"
                            OnRowDataBound="GvRedesPazCap_RowDataBound">
                            <Columns>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaRedesPaz" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            EnableFlattening="False" EntitySetName="Wv_DatosReportesHistorico" OrderBy="it.[fecha] desc"
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.Personalid == @resp || it.nombrecompleto =='0' && it.programasID = 14) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                            <WhereParameters>
                        ...
                        <asp:GridView ID="GvAdminRedesPaz" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False" Visible="false"
                            CellPadding="3" AllowPaging="True"
                            DataKeyNames="idResumenDiario" DataSourceID="EdsVistaRedesPazAdmin"
                            OnDataBound="GvAdminRedesPaz_DataBound"
                            OnRowCommand="GvAdminRedesPaz_RowCommand"
                            OnRowDataBound="GvAdminRedesPaz_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="FolioActividad" HeaderText="Folio" SortExpression="FolioActividad"></asp:BoundField>
                            ...
                            <PagerTemplate>
                                <div class="row" style="margin-top: 20px;">
                                    ...
                                    <div class="col-lg-10" style="text-align: right;">
                                        <h3>
                                            <asp:Label ID="CurrentPageLabeles1" runat="server" CssClass="label label-success" /></h3>
                                    </div>
                                </div>
                            </PagerTemplate>
                        </asp:GridView>
                        <asp:EntityDataSource runat="server" ID="EdsVistaRedesPazAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            EnableFlattening="False" EntitySetName="Wv_DatosReportesHistorico" OrderBy="it.[fecha] desc"
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.programasID = 14) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                            <WhereParameters>
                                <asp:SessionParameter DefaultValue="0" Name="resp" SessionField="responsable" DbType="Int32" />
                                <asp:SessionParameter SessionField="fInicialC" Name="fInicialC" Type="DateTime" />
                                <asp:SessionParameter SessionField="fFinalC" Name="fFinalC" Type="DateTime" />
    ...
    <script type="text/javascript">
        ...
        function ConsultaHombresXacciones() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx/ChartDataNorteAccionesta")%>',
                data: "{'x': '" + x + "'}",
        ...
        function ConsultaMuniNorte() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx/datoGraficabarteNorteMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionescentroTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx/ChartDataCentroAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunicentro() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx/datoGraficabarteCentroMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionesSurTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx/ChartDataSurAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunisur() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("vista_Redes_Veracruzanas_en_la_Construccion_de_la_Paz.aspx/datoGraficabartesurMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
