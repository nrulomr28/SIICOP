        ...
        <div class="row">
            <div id="sidebar">
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            <h1>VISTA DE RESÚMENES DEL DGPRS</h1>
                ...
                <asp:UpdatePanel runat="server" ID="upd">
                    <ContentTemplate>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaPCaAdmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) and (it.Dependencia == 'DGPRS' )  AND
                            ...
                            $.getJSON(url, function (data) {
                                ...
                                for (f; f < data.Puntos.length; f++) {
                                    ...
                                    switch (data.Puntos[f].id) {
                                        case 29:
                                            imgTipoAlerta = "../../Imagenes/Banner/DGPRS/Pines/Clases.png";
                                            break;
                                        case 30:
                                            imgTipoAlerta = "../../Imagenes/Banner/DGPRS/Pines/Motivacional.png";
                                            break;
                                        case 31:
                                            imgTipoAlerta = "../../Imagenes/Banner/DGPRS/Pines/Ejercicios.png";
                                            break;
