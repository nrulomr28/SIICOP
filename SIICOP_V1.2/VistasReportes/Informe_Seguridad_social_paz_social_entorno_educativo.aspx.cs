...
{
    public partial class Informe_Seguridad_social_paz_social_entorno_educativo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (User.IsInRole("SysAdmin") || User.IsInRole("Admin_Escolar") || User.IsInRole("CapEscolar"))
                {

                    if (this.User.IsInRole("SYSADMIN") || this.User.IsInRole("Admin_Escolar"))
                    {

                        this.GvEscolarCap.Visible = false;
                        this.GvAdminEscolar.Visible = true;
                    ...
                    else
                    {
                        ...
                        GvEscolarCap.Visible = true;
                        lkbtnexcel.Visible = false;
                        GvAdminEscolar.Visible = false;
                        GvEscolarCap.DataBind();
        ...
        protected void conteoactividadesAdmin()
        {
            ...
            if (this.txtFInicialC.Text == string.Empty)
            {
                if (this.iduser != 0)
                {
                    this.lblTotalRegistros.Text = "Registros:" + ctx.tb_Reporte_Diario.Where(x => x.programasID == 9 && x.Personalid == this.iduser).Count();

                }
                else
                {
                    this.lblTotalRegistros.Text = "Registros:" + ctx.tb_Reporte_Diario.Where(x => x.programasID == 9).Count();
            ...
            else
            {
                ...
                if (this.iduser != 0)
                {
                    this.lblTotalRegistros.Text = "Registros:" + ctx.tb_Reporte_Diario.Where(x => x.fecha >= fechainicial && x.fecha <= fechaFinal && x.programasID == 9 && x.Personalid == this.iduser).Count();

                }
                else
                {
                    this.lblTotalRegistros.Text = "Registros:" + ctx.tb_Reporte_Diario.Where(x => x.fecha >= fechainicial && x.fecha <= fechaFinal && x.programasID == 9).Count();
        ...
        protected void lkbtnexcel_Click(object sender, EventArgs e)
        {
            ...
            {
                string fechainicial = string.Format("{0:d}", this.txtFInicialC.Text);
                string fechaFinal = string.Format("{0:d}", this.txtfechafin.Text);
                int tiprograma = Convert.ToInt32(9);
                int regionid = 0;
        ...
        //                xlWorkSheet.Cells[Renglon + 2, 2].Value = dtPrincipal.Rows[Renglon]["nombre"];
        //                xlWorkSheet.Cells[Renglon + 2, 3].Value = dtPrincipal.Rows[Renglon]["RegionNombre"];
        //                xlWorkSheet.Cells[Renglon + 2, 4].Value = dtPrincipal.Rows[Renglon]["DelegacionNombre"];
        //                xlWorkSheet.Cells[Renglon + 2, 5].Value = dtPrincipal.Rows[Renglon]["MUNICIPIO"];
        //                xlWorkSheet.Cells[Renglon + 2, 6].Value = dtPrincipal.Rows[Renglon]["Localidad"];
        //                xlWorkSheet.Cells[Renglon + 2, 7].Value = dtPrincipal.Rows[Renglon]["NombrePrograma"];
        //                xlWorkSheet.Cells[Renglon + 2, 8].Value = dtPrincipal.Rows[Renglon]["NombreSubPrograma"];
        //                xlWorkSheet.Cells[Renglon + 2, 9].Value = dtPrincipal.Rows[Renglon]["AccionesNombre"];
        //                xlWorkSheet.Cells[Renglon + 2, 10].Value = dtPrincipal.Rows[Renglon]["niños"];
        //                xlWorkSheet.Cells[Renglon + 2, 11].Value = dtPrincipal.Rows[Renglon]["niñas"];
        //                xlWorkSheet.Cells[Renglon + 2, 12].Value = dtPrincipal.Rows[Renglon]["hombres"];
        //                xlWorkSheet.Cells[Renglon + 2, 13].Value = dtPrincipal.Rows[Renglon]["mujeres"];
        //                xlWorkSheet.Cells[Renglon + 2, 14].Value = dtPrincipal.Rows[Renglon]["docentesH"];
        //                xlWorkSheet.Cells[Renglon + 2, 15].Value = dtPrincipal.Rows[Renglon]["docentesM"];
        //                xlWorkSheet.Cells[Renglon + 2, 16].Value = dtPrincipal.Rows[Renglon]["TotalHombresAtendidos"];
        //                xlWorkSheet.Cells[Renglon + 2, 17].Value = dtPrincipal.Rows[Renglon]["TotalMujeresAtendidas"];
        //                xlWorkSheet.Cells[Renglon + 2, 18].Value = dtPrincipal.Rows[Renglon]["total_atendidos"];
        //                xlWorkSheet.Cells[Renglon + 2, 19].Value = dtPrincipal.Rows[Renglon]["calle"];
        //                xlWorkSheet.Cells[Renglon + 2, 20].Value = dtPrincipal.Rows[Renglon]["coloni"];
        //                xlWorkSheet.Cells[Renglon + 2, 21].Value = dtPrincipal.Rows[Renglon]["NombreLugar_Escuela"];
        //                xlWorkSheet.Cells[Renglon + 2, 22].Value = dtPrincipal.Rows[Renglon]["ClavePlantel"];
        //                xlWorkSheet.Cells[Renglon + 2, 23].Value = dtPrincipal.Rows[Renglon]["Turno"];
        //                xlWorkSheet.Cells[Renglon + 2, 24].Value = dtPrincipal.Rows[Renglon]["Nivel"];
        //                xlWorkSheet.Cells[Renglon + 2, 25].Value = dtPrincipal.Rows[Renglon]["NombreContacto"];
        //                xlWorkSheet.Cells[Renglon + 2, 26].Value = dtPrincipal.Rows[Renglon]["telcel"];
        //            }
        //        }
        //    }
        //    catch (Exception exe)
        ...
        protected void GvEscolarCap_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Editar")
            {
                ...
                {
                    Session["AccionExpediente"] = EscuelaSegura.AccionExpediente.Edicion;
                    Guid idExped = Guid.Parse(numFila.ToString());
                    Session["idExpediente_Accion"] = idExped;
                    Response.Redirect("~/Captura/Seguridad_social_paz_social_entorno_educativo.aspx");
                }
            }
        ...
        protected void GvEscolarCap_DataBound(object sender, EventArgs e)
        {
            try
            {

                // Recupera la el PagerRow...
                GridViewRow pagerRow = GvEscolarCap.BottomPagerRow;
                ...
                if ((pageList != null))
                {
                    ...
                    int i = 0;
                    for (i = 0; i <= GvEscolarCap.PageCount - 1; i++)
                    {
                        // Se crea un objeto ListItem para representar la �gina...
                        int pageNumber = i + 1;
                        ListItem item = new ListItem(pageNumber.ToString());
                        if (i == GvEscolarCap.PageIndex)
                        {
                            item.Selected = true;
                        }
                ...
                if ((pageLabel != null))
                {
                    ...
                    int currentPage = GvEscolarCap.PageIndex + 1;
                    // Actualiza el Label control con la �gina actual.
                    pageLabel.Text = "Página " + currentPage.ToString() + " de " + GvEscolarCap.PageCount.ToString();
        ...
        {
            {
                ...
                GvEscolarCap.PageIndex = pageList.SelectedIndex;
                //Quita el mensaje de información si lo hubiera...
                //lblInfo.Text = "";
            }
        }

        protected void GvAdminEscolar_DataBound(object sender, EventArgs e)
        {
            try
            {

                // Recupera la el PagerRow...
                GridViewRow pagerRow = GvAdminEscolar.BottomPagerRow;
                // Recupera los controles DropDownList y label...
                ...
                if ((pageList != null))
                {
                    // Se crean los valores del DropDownList tomando el número total de páginas... 
                    int i = 0;
                    for (i = 0; i <= GvAdminEscolar.PageCount - 1; i++)
                    {
                        // Se crea un objeto ListItem para representar la �gina...
                        int pageNumber = i + 1;
                        ListItem item = new ListItem(pageNumber.ToString());
                        if (i == GvAdminEscolar.PageIndex)
                        {
                            item.Selected = true;
                        }
                        // Se añade el ListItem a la colección de Items del DropDownList...
                ...
                {
                    // Calcula el nº de �gina actual...
                    int currentPage = GvAdminEscolar.PageIndex + 1;
                    // Actualiza el Label control con la �gina actual.
                    pageLabel.Text = "Página " + currentPage.ToString() + " de " + GvAdminEscolar.PageCount.ToString();
        ...
        protected void PageDropDownListAdmin_SelectedIndexChanged(object sender, EventArgs e)
        {
...

            {
                ...
                DropDownList pageList = (DropDownList)pagerRow.FindControl("PageDropDownListAdmin");
                // Se Establece la propiedad PageIndex para visualizar la página seleccionada...
                GvAdminEscolar.PageIndex = pageList.SelectedIndex;
                //Quita el mensaje de información si lo hubiera...
                //lblInfo.Text = "";
            }
        }
        protected void GvAdminEscolar_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Editar")
            {
                Guid numFila;
        ...
        public static List<datoGraficaPasteNorte> ChartDataNorteAccionesta(string x, string fechaInicial, string fechafinal)
        {
            ...
            try
            {
                ...
                var resultado = (from ar in ctx.tb_Reporte_Diario
                                 ...
                                 where ar.fecha >= fechainicial && ar.fecha <= fechaFinal && xr.RegionID == 1 && ar.programasID == 9
        ...
        public static List<datoGraficaPastecentro> ChartDataCentroAccionesta(string x, string fechaInicial, string fechafinal)
        {
            ...
            try
            {
                ...
                var resultado = (from bc in ctx.tb_Reporte_Diario
                                 ...
                                 where bc.fecha >= fechainicial && bc.fecha <= fechaFinal && nb.RegionID == 2 && bc.programasID == 9
        ...
        public static List<datoGraficabartecentro> datoGraficabarteCentroMuni(string x, string fechaInicial, string fechafinal)
        {
            ...
            try
            {
                ...
                var resultado = (from arx in ctx.tb_Reporte_Diario
                                 ...
                                 where arx.fecha >= fechainicial && arx.fecha <= fechaFinal && xry.RegionID == 2 && arx.programasID == 9
        ...
        public static List<datoGraficaPasteSur> ChartDataSurAccionesta(string x, string fechaInicial, string fechafinal)
        {
            ...
            try
            {
                ...
                var resultado = (from bxc in ctx.tb_Reporte_Diario
                                 ...
                                 where bxc.fecha >= fechainicial && bxc.fecha <= fechaFinal && nb.RegionID == 3 && bxc.programasID == 9
        ...
        public static List<datoGraficabartesur> datoGraficabartesurMuni(string x, string fechaInicial, string fechafinal)
        {
            ...
            try
            {
                ...
                var resultado = (from xxx in ctx.tb_Reporte_Diario
                                 ...
                                 where xxx.fecha >= fechainicial && xxx.fecha <= fechaFinal && rrr.RegionID == 3 & xxx.programasID == 9
        ...
        protected void GvEscolarCap_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
        ...
        protected void GvAdminEscolar_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
        ...
        private void Conteo_A_B_TB_X_Cargadetrabajo()
        {
            ...
            //ACCIONES
            tbCarga_trabajo_Dele AccionesXareaObjXAL = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "CONURBACION XALAPA XX" && x.Tipo_TA_BA_TB == 1).FirstOrDefault();
            ...
            this.spanAccionXareaObjtXAL.InnerText = (from s in ctx.tb_Reporte_Diario
                                                     join std in ctx.tb_DireccionReporte
                                                     on s.idResumenDiario equals std.idResumenDiario
                                                     where s.fecha.Value.Month >= mesactual && s.DelegacionOcoonurbacion == "CONURBACION XALAPA XX" && s.programasID == 9
            ...
            tbCarga_trabajo_Dele beneficiadosGralxmesdOBJXAL = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "CONURBACION XALAPA XX" && x.Tipo_TA_BA_TB == 3).FirstOrDefault();
            ...
            //ACCIONES
            tbCarga_trabajo_Dele AccionesXareaObjVER = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "CONURBACION VERACRUZ XXIII" && x.Tipo_TA_BA_TB == 1).FirstOrDefault();
            ...
            this.spanAccionXareaObjtVER.InnerText = (from s in ctx.tb_Reporte_Diario
                                                     join std in ctx.tb_DireccionReporte
                                                     on s.idResumenDiario equals std.idResumenDiario
                                                     where s.fecha.Value.Month >= mesactual && s.DelegacionOcoonurbacion == "CONURBACION VERACRUZ XXIII" && s.programasID == 9
                                                     select s.programasID).Count().ToString();
            ...
            //CONTEO DE BENEFICIADOS POR MES 
            tbCarga_trabajo_Dele beneficiadosGralxmesdOBJVER = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "CONURBACION VERACRUZ XXIII" && x.Tipo_TA_BA_TB == 3).FirstOrDefault();
            ...
            //ACCIONES
            tbCarga_trabajo_Dele AccionesXareaObjPOZA = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "CONURBACION POZA RICA" && x.Tipo_TA_BA_TB == 1).FirstOrDefault();
            ...
            this.spanAccionXareaObjtPOZA.InnerText = (from s in ctx.tb_Reporte_Diario
                                                      join std in ctx.tb_DireccionReporte
                                                      on s.idResumenDiario equals std.idResumenDiario
                                                      where s.fecha.Value.Month >= mesactual && s.DelegacionOcoonurbacion == "CONURBACION POZA RICA" && s.programasID == 9
                                                      select s.programasID).Count().ToString();
            ...
            //CONTEO DE BENEFICIADOS POR MES 
            tbCarga_trabajo_Dele beneficiadosGralxmesdOBJPOZA = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "CONURBACION POZA RICA" && x.Tipo_TA_BA_TB == 3).FirstOrDefault();
            ...
            //ACCIONES
            tbCarga_trabajo_Dele AccionesXareaObjCOR = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "COORDINACION CORDOBA" && x.Tipo_TA_BA_TB == 1).FirstOrDefault();
            ...
            this.spanAccionXareaObjTCOR.InnerText = (from s in ctx.tb_Reporte_Diario
                                                     join std in ctx.tb_DireccionReporte
                                                     on s.idResumenDiario equals std.idResumenDiario
                                                     where s.fecha.Value.Month >= mesactual && s.DelegacionOcoonurbacion == "COORDINACION CORDOBA" && s.programasID == 9
                                                     select s.programasID).Count().ToString();
            ...
            //CONTEO DE BENEFICIADOS POR MES 
            tbCarga_trabajo_Dele beneficiadosGralxmesdOBJCOR = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "COORDINACION CORDOBA" && x.Tipo_TA_BA_TB == 3).FirstOrDefault();
            ...
            //ACCIONES
            tbCarga_trabajo_Dele AccionesXareaObjCOATZA = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "COORDINACION COATZACOALCOS" && x.Tipo_TA_BA_TB == 1).FirstOrDefault();
            ...
            this.spanAccionXareaObjtCOATZA.InnerText = (from s in ctx.tb_Reporte_Diario
                                                        join std in ctx.tb_DireccionReporte
                                                        on s.idResumenDiario equals std.idResumenDiario
                                                        where s.fecha.Value.Month >= mesactual && s.DelegacionOcoonurbacion == "COORDINACION COATZACOALCOS" && s.programasID == 9
                                                        select s.programasID).Count().ToString();
            ...
            //CONTEO DE BENEFICIADOS POR MES 
            tbCarga_trabajo_Dele beneficiadosGralxmesdOBJCOATZA = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "COORDINACION COATZACOALCOS" && x.Tipo_TA_BA_TB == 3).FirstOrDefault();
            ...
            //ACCIONES
            tbCarga_trabajo_Dele AccionesXareaObjENLACE = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "Enlace" && x.Tipo_TA_BA_TB == 1).FirstOrDefault();
            ...
            this.spanAccionXareaObjtENLACE.InnerText = (from s in ctx.tb_Reporte_Diario
                                                        join std in ctx.tb_DireccionReporte
                                                        on s.idResumenDiario equals std.idResumenDiario
                                                        where s.fecha.Value.Month >= mesactual && s.DelegacionOcoonurbacion == "ENLACES" && s.programasID == 9
                                                        select s.programasID).Count().ToString();
            ...
            //CONTEO DE BENEFICIADOS POR MES 
            tbCarga_trabajo_Dele beneficiadosGralxmesdOBJENLACE = this.ctx.tbCarga_trabajo_Dele.Where(x => x.programa == 9 && x.Mes_Num == mesactual && x.Delegacion == "Enlace" && x.Tipo_TA_BA_TB == 3).FirstOrDefault();
