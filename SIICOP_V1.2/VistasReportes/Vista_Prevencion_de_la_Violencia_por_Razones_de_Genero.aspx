<%@ Page Title="PREVENCIÓN DE LA VIOLENCIA POR RAZONES DE GÉNERO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">PREVENCIÓN DE LA VIOLENCIA POR RAZONES DE GÉNERO</h5>
                        </div>
                        <div class="link-me">
                        </div>
                    </div>
        ...
        <div class="well" style="background-color: white">
            ...
            <div class="row">
                <asp:UpdatePanel runat="server" ID="upd">
                    <ContentTemplate>
                        <asp:GridView ID="GvPVM" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False" DataKeyNames="idResumenDiario"
                            DataSourceID="EdsVistaEscolar" CellPadding="3" AllowPaging="True" Visible="false"
                            OnDataBound="GvPVM_DataBound"
                            OnRowCommand="GvPVM_RowCommand"
                            OnRowDataBound="GvPVM_RowDataBound">
                            <Columns>
                              ...
                              <asp:BoundField DataField="MUNICIPIO" HeaderText="Municipio" SortExpression="MUNICIPIO"></asp:BoundField>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    ...
                                    <i  class="glyphicon glyphicon-pencil" style="font-size:1.8em" aria-hidden="true"></i>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaEscolar" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.Personalid == @resp || it.nombrecompleto =='0' && it.programasID = 10) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                            <WhereParameters>
                        ...
                        <%--grid administrativo--%>
                        <asp:GridView ID="GvPVMadmin" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False" DataKeyNames="idResumenDiario"
                            DataSourceID="EdsVistaPVMadmin"
                            CellPadding="3" AllowPaging="True" Visible="false"
                            OnDataBound="GvPVMadmin_DataBound"
                            OnRowCommand="GvPVMadmin_RowCommand"
                            OnRowDataBound="GvPVMadmin_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="FolioActividad" HeaderText="Folio" HeaderStyle-CssClass="col-md-1" SortExpression="FolioActividad"></asp:BoundField>
                                <asp:BoundField DataField="fecha" HeaderText="Fecha" SortExpression="fecha" DataFormatString="{0:dddd-dd-MMMM-yyyy}"></asp:BoundField>
                              <asp:BoundField DataField="MUNICIPIO" HeaderText="Municipio" SortExpression="MUNICIPIO"></asp:BoundField>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" Text="Editar" CommandName="Editar" CausesValidation="False" ID="lkbEditar" ToolTip="Editar" CommandArgument='<%# Eval("idResumenDiario") %>'>
                                    <%--<i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size:1.8em"></i>--%>
                            ...
                            <PagerTemplate>
                                <div class="row" style="margin-top: 20px;">
                                    ...
                                    <div class="col-lg-10" style="text-align: right;">
                                        <h3>
                                            <asp:Label ID="CurrentPageLabelr" runat="server" CssClass="label label-success" /></h3>
                                    </div>
                                </div>
                            </PagerTemplate>
                        </asp:GridView>
                        <asp:EntityDataSource runat="server" ID="EdsVistaPVMadmin" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            EnableFlattening="False" EntitySetName="Wv_DatosReportesHistorico"
                            OrderBy="it.[fecha] desc"
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.programasID = 10) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
    ...
    <script type="text/javascript">
        ...
        function ConsultaHombresXacciones() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero.aspx/ChartDataNorteAccionesta")%>',
                data: "{'x': '" + x + "'}",
        ...
        function ConsultaMuniNorte() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero.aspx/datoGraficabarteNorteMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionescentroTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero.aspx/ChartDataCentroAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunicentro() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero.aspx/datoGraficabarteCentroMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionesSurTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero.aspx/ChartDataSurAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunisur() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Vista_Prevencion_de_la_Violencia_por_Razones_de_Genero.aspx/datoGraficabartesurMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
