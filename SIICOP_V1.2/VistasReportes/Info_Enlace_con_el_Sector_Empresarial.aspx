<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Info_Enlace_con_el_Sector_Empresarial.aspx.cs" Inherits="SIICOP_V1._2.VistasReportes.InfoEmpresarial" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="sosmed">
                    <div class="user">
                        <div class="user-head">
                            ...
                            <h5 style="color: #feff00">ENLACE CON EL SECTOR EMPRESARIAL</h5>
                        </div>
                        <div class="link-me">
                        </div>
                    </div>
    ...
    <div class="container-fluid">
        <div class="well" style="background-color: white">
            ...
            <asp:UpdatePanel runat="server" ID="upd">
                <ContentTemplate>
                    <div class="row">
                        <asp:GridView ID="GvSectorEmpreCap" runat="server" CssClass="table table-condensed table-bordered" AutoGenerateColumns="False" Visible="false"
                            CellPadding="3" AllowPaging="True"
                            DataKeyNames="idResumenDiario" DataSourceID="EdsVistaEscolar"
                            OnDataBound="GvSectorEmpreCap_DataBound"
                            OnRowCommand="GvSectorEmpreCap_RowCommand"
                            OnRowDataBound="GvSectorEmpreCap_RowDataBound">
                            <Columns>
                             ...
                             <asp:BoundField DataField="MUNICIPIO" HeaderText="Municipio" SortExpression="MUNICIPIO"></asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="¿Fotos cargadas?">
                                    <ItemTemplate>
                                        ...
                                        <%--<asp:Image runat="server" AlternateText='<%# Eval("fotos") %>' ID="imgpato" Width="25" Height="25"></asp:Image>--%>
                                    </ItemTemplate>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaEscolar" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            ...
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.Personalid == @resp || it.nombrecompleto =='0' && it.programasID = 13) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                            <%--     Where="it.Personalid == @resp || it.nombrecompleto =='0' && it.programasID = 1">--%>
                            <WhereParameters>
                        ...
                        <%--administrador--%>
                        <asp:GridView runat="server" ID="GvSEMPAdmin" AutoGenerateColumns="False" DataKeyNames="idResumenDiario" DataSourceID="EdsVistaEmpresarialAdmi"
                            CssClass="table table-condensed table-bordered" Visible="false" CellPadding="3" AllowPaging="True"
                            OnDataBound="GvSEMPAdmin_DataBound"
                            OnRowCommand="GvSEMPAdmin_RowCommand"
                            OnRowDataBound="GvSEMPAdmin_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="FolioActividad" HeaderText="Folio" HeaderStyle-CssClass="col-md-1" SortExpression="FolioActividad"></asp:BoundField>
                                <asp:BoundField DataField="fecha" HeaderText="fecha" SortExpression="fecha" DataFormatString="{0:dddd-dd-MMMM-yyyy}"></asp:BoundField>
                              <asp:BoundField DataField="MUNICIPIO" HeaderText="Municipio" SortExpression="MUNICIPIO"></asp:BoundField>
                        ...
                        <asp:EntityDataSource runat="server" ID="EdsVistaEmpresarialAdmi" DefaultContainerName="SIICOPEntities" ConnectionString="name=SIICOPEntities"
                            EnableFlattening="False" EntitySetName="Wv_DatosReportesHistorico" OrderBy="it.[fecha] desc"
                            Where="((@fInicialC IS NULL OR it.fecha >= @fInicialC) AND (@fFinalC IS NULL OR it.fecha <= @fFinalC) AND (it.programasID = 13) and (@Folio is null or it.descripcion_actividad like '%' + @Folio + '%'))">
                            <WhereParameters>
                                            ...
                                            <div class="card table-card widget-primary-card">
                                                <div class="">
                                                    <div class="row-table">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <h2 runat="server" id="HPLATICAS"></h2>
                                                            <h4>Platicas</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card table-card widget-primary-card">
                                                <div class="">
                                                    <div class="row-table">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <h2 runat="server" id="HCONVENIOS"></h2>
                                                            <h4>Convenios</h4>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        function ConsultaHombresXacciones() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Enlace_con_el_Sector_Empresarial.aspx/ChartDataNorteAccionesta")%>',
                data: "{'x': '" + x + "'}",
        ...
        function ConsultaMuniNorte() {
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Enlace_con_el_Sector_Empresarial.aspx/datoGraficabarteNorteMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionescentroTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Enlace_con_el_Sector_Empresarial.aspx/ChartDataCentroAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunicentro() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Enlace_con_el_Sector_Empresarial.aspx/datoGraficabarteCentroMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function AccionesSurTtotal() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Enlace_con_el_Sector_Empresarial.aspx/ChartDataSurAccionesta")%>',
                data: "{'x': '" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function ConsultaMunisur() {
            ...
            $.ajax({
                type: "POST",
                url: '<%= ResolveUrl("Info_Enlace_con_el_Sector_Empresarial.aspx/datoGraficabartesurMuni")%>',
                data: "{'x':'" + x + "'}",
                data: JSON.stringify({ 'fechaInicial': fechaInicial, 'fechafinal': fechafinal, 'x': x }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
